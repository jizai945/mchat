...
class SetupMainWindow:
    ...
    def setup_gui(self):
        ...
        self.icon_2 = QIcon(Functions.set_svg_icon("icon_idle.svg"))
        self.btn_clear.setMinimumHeight(40)
        self.btn_clear.setIcon(self.icon_2)

        self.le_send_text = PyLineEdit(
            text = "",
            place_holder_text = "Place holder text",
            radius = 8,
            border_size = 2,
        ...
        self.le_send_text.setMinimumHeight(30)
        self.le_send_text.setText('test')
